...
TEST_FRIENDS = ['boulanger', 'ASUS_ROG_FR', 'SpottersMedia', 'KennyLeRetour', 'yungfilly1', 'Chunkz', 'tfadell', 'oneseconddrama', 'Lmfaoos', 'blczinedine', 'hourly_shitpost', 'heykahn', 'gaspardooo', 'maximebiaggi', 'winnterzuko', 'inesvarri', 'Crapauwer', '_Confessfantasm', 'LogitechGFrance', 'YassineTwt', 'ekWateur', 'MelHssn', 'itachi_rl', 'TopDesHagras', 'miakhalifa', 'Caedrel', 'MisterVonline', 'Eminem', 'Vandiril', '_IDVL', 'karmaaOfficiel', 'HxHVizuals', 'imdhav', 'ClmentBarbier3', 'VilebrequinAuto', 'Google', 'BBCWorld', 'NASA', 'SpaceX', 'JeffBezos', 'lolesports', 'FrMinecraft', 'elonmusk', 'c_bumstead', 'Marvel_Fit', 'AKG_Luffy', 'O_Robiii', 'PrimeTimeFUT', 'leroidesrats', 'LEC', 'Zack_Nani', 'Ricadam_lol', 'SKIDIDIPOPOFF', 'AlderiateTV',
                'TrainerDouble', 'ghidraninja', 'EmirMalte', 'TeufeurSoff', 'Seb_Frit', 'AypierreMc', 'befreesh_', 'Chap_GG', 'Gotaga', 'LiveOverflow', 'KCORP_ULTRAS', 'Doigby', 'MaulCKX', 'RebeuDeter', 'PatrickAdemo', 'AmineMaTue', 'KametoTV', 'Cinkroflol', '113bumm', 'Domingo', 'Sardoche_Lol', 'LRB_LoL', 'TraYt0N', 'OTP_LoL', 'Karnagemvp', 'Xav_Oswald', 'Lockl34r', 'AREtoiles', 'CabochardLoL', 'KarmineCorp', 'Arkunir', 'Targamas', 'Kammeto', 'Twisted_Chips', 'kPeriods', 'Mickalow', 'Hanteralol', 'LEC_Wooloo', 'Saken_lol', 'RekklesLoL', 'JLMelenchon', 'GotagaTV', 'Bren_TM2', 'Fatiiiih_', 'ZeratoR', 'LoL_France', 'Striker_KC', 'Nuclear_int', 'KoteiZousa', 'LaureBuliiV', 'SamuelEtienne', 'Nisqy', 'EUMasters', 'Ilias__ll', 'Chrichribg', 'joedaou961', 'laura_bnvd']
TEST_FRIEND_IDS = [
...
G.add_nodes_from(TEST_FRIENDS)

for f in TEST_FRIENDS:
